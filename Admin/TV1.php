...
<body>
  	...
  	if(isset($_POST["ok"]))
    {
	  ...
	  move_uploaded_file($_FILES['photo']['tmp_name'],$pic);
		    ...
		    $query="INSERT INTO `tv1`(`brand`, `model`, `screen`, `internet`, `display`, `product`,
             `resolution`, `refresh`, `feature`, `hardware`, `connector`, `price`, `image`) 
             VALUES ('".$_POST["Brand"]."','".$_POST["Model"]."','".$_POST["Screen"]."','".$_POST["Internet"]."',
             '".$_POST["Display"]."','".$_POST["Product"]."','".$_POST["Resolution"]."','".$_POST["Refresh"]."',
             '".$_POST["Feature"]."','".$_POST["Hardware"]."','".$_POST["Connector"]."','".$_POST["Price"]."','$pic')";
