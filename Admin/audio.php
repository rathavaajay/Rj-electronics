...
<body>
  	...
  	if(isset($_POST["ok"]))
    {
	  ...
	  move_uploaded_file($_FILES['photo']['tmp_name'],$pic);
		    ...
		    $query="insert into audio(brand,model,colour,factor,connector,price,image)
             values('".$_POST["Brand"]."','".$_POST["Model"]."','".$_POST["Colour"]."','".$_POST["Factor"]."',
             '".$_POST["Connector"]."','".$_POST["Price"]."','$pic')";
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Add New Headphones</h6>
