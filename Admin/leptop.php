...
<body>
  	...
  	if(isset($_POST["ok"]))
    {
	  ...
	  move_uploaded_file($_FILES['photo']['tmp_name'],$pic);
		    ...
		    $query="insert into laptop(brand,model,colour,screenSize,cpu,ram,operatingSystem,generation,specialFeature,graphicsCard,
            windows,storage,ssdORhdd,price,image)
            values('".$_POST["Brand"]."','".$_POST["Model"]."','".$_POST["Colour"]."','".$_POST["Screen"]."','".$_POST["CPU"]."',
            '".$_POST["RAM"]."','".$_POST["Operating"]."',
            '".$_POST["Generation"]."','".$_POST["Special"]."','".$_POST["Graphics"]."','".$_POST["Windows"]."',
            '".$_POST["Storage"]."',
            '".$_POST["ssd"]."','".$_POST["Price"]."','$pic')";
				$result= mysqli_query($conn,$query);
					if($result)
					{
						echo"<script>alert('Photo uploaded Sucessfully..')</script>";
					}
					else {
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Add New Laptop</h6>
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <select name="RAM" class="form-select" id="floatingSelect"
                                        aria-label="Floating label select example">
                                        <option selected>RAM Memory Installed Size</option>
                                        <option>4 GB</option>
                                        <option>6 GB</option>
                                        <option>8 GB</option>
                                        <option>16 GB</option>
                                ...
                                <div class="form-floating mb-3">
                                    <select name="Graphics" class="form-select" id="floatingSelect"
                                        aria-label="Floating label select example">
                                        <option selected>Select Graphics Card Description</option>
                                ...
                                <div class="form-floating mb-3">
                                    <select name="Windows" class="form-select" id="floatingSelect"
                                        aria-label="Floating label select example">
                                        <option selected>Select Windows</option>
                                ...
                                <div class="form-floating mb-3">
                                    <select name="ssd" class="form-select" id="floatingSelect"
                                        aria-label="Floating label select example">
                                        <option selected>Select SSD OR HDD</option>
                                        <option>SSD</option>
                                        <option>HDD</option>
                                    </select>
