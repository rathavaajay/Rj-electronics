...
<body>
  	...
  	if(isset($_POST["ok"]))
    {
	  ...
	  move_uploaded_file($_FILES['photo']['tmp_name'],$pic);
		    ...
		    $query="insert into mobile(brand,model,network,os,cellular,colour,ram,storage,about,price,image)
             values('".$_POST["Brand"]."','".$_POST["Model"]."','".$_POST["Network"]."','".$_POST["Os"]."',
             '".$_POST["Cellular"]."','".$_POST["Colour"]."','".$_POST["Ram"]."','".$_POST["Storage"]."','".$_POST["About"]."',
             '".$_POST["Price"]."','$pic')";
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Add New Mobile</h6>
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="Cellular"class="form-control">
                                </div>
