  ...
  <div class="container-fluid">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Update TV Details</h6>
    ...
    if(isset($_POST["ok"]))
    {
	  ...
	  move_uploaded_file($_FILES['photo']['tmp_name'],$pic);
        ...
        $id=$_REQUEST["id"];
        $query="UPDATE `tv1` SET `brand`='".$_POST['Brand']."',`model`='".$_POST['Model']."',`screen`='".$_POST['Screen']."',
        `internet`='".$_POST['Internet']."',`display`='".$_POST['Display']."',`product`='".$_POST['Product']."',
        `resolution`='".$_POST['Resolution']."',`refresh`='".$_POST['Refresh']."',`feature`='".$_POST['Feature']."',
        `hardware`='".$_POST['Hardware']."',`connector`='".$_POST['Connectore']."',`price`='".$_POST['Price']."',
...
?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="<?php echo $row["screen"] ?>"name="Screen" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Supported Internet Services</label>
                                    <input type="text" value="<?php echo $row["internet"] ?>"name="Internet" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Display Technology</label>
                                    <input type="text" value="<?php echo $row["display"] ?>"name="Display" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Product Dimensions</label>
                                    <input type="text" value="<?php echo $row["product"] ?>"name="Product" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Resolution</label>
                                    <input type="text" value="<?php echo $row["resolution"] ?>"name="Resolution" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Refresh Rate</label>
                                    <input type="text" value="<?php echo $row["refresh"] ?>"name="Refresh" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Special Feature</label>
                                    <input type="text" value="<?php echo $row["feature"] ?>"name="Feature" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Mounting Hardware</label>
                                    <input type="text" value="<?php echo $row["hardware"] ?>"name="Hardware" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Connector Type</label>
                                    <input type="text" value="<?php echo $row["connector"] ?>"name="Connectore" class="form-control">
                                </div>
                                <div class="mb-3">
