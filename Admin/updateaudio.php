  ...
  <div class="container-fluid">
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Update Headphone Details</h6>
    ...
    if(isset($_POST["ok"]))
    {
	  ...
	  move_uploaded_file($_FILES['photo']['tmp_name'],$pic);
        ...
        $id=$_REQUEST["id"];
        $query="UPDATE `audio` SET `brand`='".$_POST['Brand']."',`model`='".$_POST['Model']."',`colour`='".$_POST['Colour']."',
        `factor`='".$_POST['Factor']."',`connector`='".$_POST['Connector']."',`price`='".$_POST['Price']."',`image`='$pic' WHERE `id` = $id;";
...
?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Headphones form factor</label>
                                    <input type="text" value="<?php echo $row["factor"] ?>" name="Factor"class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Connector Type</label>
                                    <input type="text" value="<?php echo $row["connector"] ?>" name="Connector"class="form-control">
                                </div>
                                <div class="mb-3">
