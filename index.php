                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <button class="buy" onClick="window.location.href='order2.php?id=<?php echo $row['id']?>';">
                                        <span class="fa fa-shopping-card"></span>
                                            Buy now
                                        </button>
                                        </td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <button class="buy" onClick="window.location.href='order3.php?id=<?php echo $row['id']?>';">
                                        <span class="fa fa-shopping-card"></span>
                                            Buy now
                                        </button>
                                        </td>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <button class="buy" onClick="window.location.href='order4.php?id=<?php echo $row['id']?>';">
                                        <span class="fa fa-shopping-card"></span>
                                            Buy now
                                        </button>
                                        </td>
